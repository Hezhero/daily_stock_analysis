...
def resolve_name_to_code(name: str) -> Optional[str]:
    ...
    4. Fuzzy match (difflib) against local names.
    5. Return None.

    Note: AKShare online fallback has been removed.
    ...
    # 4. Fuzzy match (local only, AKShare removed)
